						...
						<div class="box-body">
							<div class="col-md-6">
								...
								<div class="form-group <?= isset($error['user_email']) ? 'has-error' : 'has-feedback' ?>">
									<input type="text" class="form-control" name="user_email" id="user_email" placeholder="Email" value="<?= isset($_POST['user_email']) ? $_POST['user_email'] : '' ?>">
								...
								<div class="form-group <?= isset($error['user_mobile']) ? 'has-error' : 'has-feedback' ?>">
									<input type="text" class="form-control" name="user_mobile" id="user_mobile" placeholder="Mobile" value="<?= isset($_POST['user_mobile']) ? $_POST['user_mobile'] : '' ?>">
									<span class="glyphicon glyphicon-envelope form-control-feedback"></span>
