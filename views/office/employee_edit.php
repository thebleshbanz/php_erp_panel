						...
						<div class="box-body">
							<div class="col-md-6">
								<div class="form-group has-feedback">
									<input type="text" class="form-control" name="employeeName" id="employeeName" placeholder="Employee Full name" value="<?= isset($employee->firstName) ? $employee->firstName." ".$employee->lastName : '' ?>">
									<span class="glyphicon glyphicon-user form-control-feedback"></span>
									<?= isset($error['employeeName']) ? '<span class="help-block">'.$error["employeeName"].'</span>' : '' ?>
								</div>
								
								<div class="form-group has-feedback">
									<input type="text" class="form-control" name="extension" id="extension" placeholder="Extension" value="<?= isset($employee->extension) ? $employee->extension : '' ?>">
									<span class="glyphicon glyphicon-envelope form-control-feedback"></span>
									<?= isset($error['extension']) ? '<span class="help-block">'.$error["extension"].'</span>' : '' ?>
								</div>
								
								<div class="form-group has-feedback">
									<input type="text" class="form-control" name="email" id="email" placeholder="Email" value="<?= isset($employee->email) ? $employee->email : '' ?>">
									<span class="glyphicon glyphicon-envelope form-control-feedback"></span>
							...
							<div class="col-md-6">
								...
								<div class="form-group has-feedback">
									...
									<span class="glyphicon glyphicon-envelope form-control-feedback"></span>
									<?= isset($error['reportTo_res']) ? '<span class="help-block">'.$error["reportTo_res"].'</span>' : '' ?>
								</div>
							</div>
						</div>
						<!-- /.box-body -->
