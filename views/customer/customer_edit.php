						...
						<div class="box-body">
							<div class="col-md-6">
								...
								<div class="form-group <?= isset($error['customerName']) ? 'has-error' : 'has-feedback' ?>">
									<input type="text" class="form-control" name="customerName" id="customerName" placeholder="Full name" value="<?= isset($customer->customerName) ? $customer->customerName : '' ?>">
								...
								<div class="form-group <?= isset($error['contactFullName']) ? 'has-error' : 'has-feedback' ?>">
									<input type="text" class="form-control" name="contactFullName" id="contactFullName" placeholder="Enter Contact Full Name with spance" value="<?= (isset($customer->contactFirstName) && isset($customer->contactLastName) ) ? $customer->contactFirstName.' '.$customer->contactLastName : '' ?>">
								...
								<div class="form-group <?= isset($error['phone']) ? 'has-error' : 'has-feedback' ?>">
									<input type="text" class="form-control" name="phone" id="phone" placeholder="Mobile" value="<?= isset($customer->phone) ? $customer->phone : '' ?>">
									<span class="glyphicon glyphicon-envelope form-control-feedback"></span>
								...
								<div class="form-group <?= isset($error['creditLimit']) ? 'has-error' : 'has-feedback' ?>">
									<input type="text" class="form-control" name="creditLimit" id="creditLimit" placeholder="credit Limit" value="<?= isset($customer->creditLimit) ? $customer->creditLimit : '' ?>">
									<span class="glyphicon glyphicon-envelope form-control-feedback"></span>
							...
							<div class="col-md-6">
								<div class="form-group <?= isset($error['city']) ? 'has-error' : 'has-feedback' ?>">
									<input type="text" class="form-control" name="city" id="city" placeholder="Enter city" value="<?= isset($customer->city) ? $customer->city : '' ?>">
									<span class="glyphicon glyphicon-envelope form-control-feedback"></span>
									<?= isset($error['city']) ? '<span class="help-block">'.$error["city"].'</span>' : '' ?>
								</div>
								
								<div class="form-group <?= isset($error['postalCode']) ? 'has-error' : 'has-feedback' ?>">
									<input type="text" class="form-control" name="postalCode" id="postalCode" placeholder="postalCode" value="<?= isset($customer->postalCode) ? $customer->postalCode : '';?>">
									<span class="glyphicon glyphicon-envelope form-control-feedback"></span>
									<?= isset($error['postalCode']) ? '<span class="help-block">'.$error["postalCode"].'</span>' : '' ?>
								</div>

								<div class="form-group has-feedback">
									<textarea class="form-control" name="addressLine1" id="addressLine1" rows="5" placeholder="Enter address Line 1"><?= isset($customer->addressLine1) ? $customer->addressLine1 : '' ?></textarea>
								</div>

								<div class="form-group has-feedback">
									<textarea class="form-control" name="addressLine2" id="addressLine2" rows="5" placeholder="Enter address Line 2"><?= isset($customer->addressLine2) ? $customer->addressLine2 : '' ?></textarea>
								</div>
							</div>
						</div>
						<!-- /.box-body -->
